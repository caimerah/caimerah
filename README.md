...
- 📌 **Adopt-a-Barangay** – Resident Profiling + Analytics Web App (CRUD, reports, charts)  
- 📌 **Student Management System** – CRUD application with a minimalist UI  
- 📌 **Dengue Case Tracker** – CSV-based dashboard with data visualization  
...
## 📊 Current Goals
- Strengthen **backend development** with Node.js + Redis  
- Master **database optimization & system integration**  
- Improve **UI/UX design** for modern web apps  
- Build more **data visualization & analytics tools**  

---

## 📫 Connect with Me
- GitHub: [github.com/caimerah](https://github.com/caimerah)  
- Email: abdulcaimerah03@gmail.com 
